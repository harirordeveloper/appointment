class CorporateHealthPackagesController < ApplicationController
  ...
  def index
    @corporate_health_packages = CorporateHealthPackage.all
	 ...
	 @corporate_health_package.branch_code=@person.branch_name
	 @corporate_health_package.branch_location=@person.branch_location
 	 20.times{ @corporate_health_package.corporate_health_package_children.build }
    respond_to do |format|
      format.html # index.html.erb
      format.xml  { render :xml => @corporate_health_packages }
    end
  end
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.xml  { render :xml => @corporate_health_package }
    end
  end
